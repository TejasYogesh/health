    ...
    return (
        <div className='bg-black h-screen'>
            <motion.p
                ...
                className='text-4xl p-8 font-bold text-blue-400 text-white text-center'>Chapter 02</motion.p>
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 1.5 }}
                trans className='text-white text-8xl font-bold text-center p-10'>Human Execretory System.</motion.div>
            <motion.p initial={{ opacity: 0 }}
                ...
                className='text-white mx-14 text-xl'>The human excretory 
            ...
            <motion.div className='flex'
                ...
                <div className='py-10 px-4'>
                    <a href="src/Pages/10Project/blood2.html" className='text-black bg-white rounded-xl m-10 p-4'>View More</a>
                </div>
                <div>
